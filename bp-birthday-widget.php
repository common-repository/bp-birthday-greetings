...
class BP_Birthday_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if ( empty( $birthdays ) ) {
			...
			echo wp_kses_post( '<ul class="birthday-members-list">' );
			foreach ( $birthdays as $birthday => $members_id ) {
				...
				echo wp_kses_post( '<li>' . bp_core_fetch_avatar( array( 'item_id' => $members_id, 'type' => $dp_type, 'width' => $dp_width, 'height' => $dp_height, 'class' => 'avatar', 'html' => true ) ) );
				echo esc_html__( 'Happy Birthday', 'bp-birthday-greetings' );
				echo wp_kses_post( ' ' . $member_name . ' ' . $cake_img . '</li>' );
